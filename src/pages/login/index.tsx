...
import HorizonImage from '../../../public/horizon.webp';
    ...
    return (
        <div className="login-page">
            ...
            <div className="login-page__left">
                <img src={HorizonLogo} alt="Horizon | BlueSky Web Client" />
                
                <h2>Horizon | BlueSky Web Client</h2>
                <form onSubmit={_handleSubmit}>
                    ...
                    <p>Horizon is an <a href="https://github.com/vheuel/horizon" className="font-weight-bold" title="Horizon | A Bluesky Web Client" target="_blank">open-source</a> web app developed by @vheuel.bsky.social</p>
                    <p>There's no credentials or personal data being sent to any other server than the official Bluesky server. But it's still recommended to use Horizon with <a href="https://github.com/bluesky-social/atproto-ecosystem/blob/main/app-passwords.md" title="App Passwords" target="_blank" className="font-weight-bold">App Passwords</a>. Only data collected is by using Google Analytics to keep track of Horizon's user count.</p>
                </form>
            </div>
            <div className="login-page__right">
                <img src={HorizonImage} alt="" />
            </div>
        </div>
    );
}