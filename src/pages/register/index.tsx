        ...
        <div className="login-page">
            <div className="login-page__left">
                ...
                <form onSubmit={_handleSubmit}>
                    ...
                    <p>Horizon is an <a href="https://github.com/vheuel/horizon" className="font-weight-bold" title="Horizon : Bluesky Web Client" target="_blank">open-source</a> web app developed by @vheuel.bsky.social</p>
            ...
            <div className="login-page__right">
                <img src={HorizonImage} alt="Horizon" />
            </div>
        </div>
    );
}